...
export const BUILDINGS: BuildingDef[] = [
  ...
  // ⚙ Промышленные
  B("ges", "ГЭС", "industry", "Паровой двигатель", 4, "Клик по своей ГЭС — 1 💰, без действия, получить 1 Электричество", "1 Силикаты + 1 Лес + 2 Металл", [specific("silicates", 1), specific("wood", 1), specific("metalOre", 2)], false, { resource: "electricity", qty: 1 }),
  B("aes", "АЭС", "industry", "Атомная энергия", 5, "Клик по своей АЭС — 1 💰, без действия, получить 2 Электричества", "1 Силикаты + 1 Металл + 2 Уран", [specific("silicates", 1), specific("metalOre", 1), specific("uranium", 2)], false, { resource: "electricity", qty: 2 }),
