...
export const BUILDINGS: BuildingDef[] = [
  ...
  B("kosmodrom", "Космодром", "industry", "Космонавтика", 6, "Без действия — 1 Металл + 1 Редкоземельные + 1 Углеводороды, без денег, без лимита цикла — +1 компонент корабля, накопительно за партию; 3 компонента = 🏆 победа через космос", "1 Силикаты + 1 Металл + 2 Редкоземельные", [specific("silicates", 1), specific("metalOre", 1), specific("rareEarth", 2)], true),
