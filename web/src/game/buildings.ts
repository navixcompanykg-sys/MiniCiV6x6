...
export const BUILDINGS: BuildingDef[] = [
  // ⚔ Военные
  B("kazarma", "Казарма", "military", "Бронзовое дело", 1, "1 действие + обычная цена юнита по эпохе, без карты — строит 1 Воина в любом своём городе", "1 Силикаты + 3 Лес", [specific("silicates", 1), specific("wood", 3)]),
  ...
  B("rynok", "Рынок", "economy", "Экономика", 3, "1 действие + 1 Углеводороды или 1 Электричество со склада — тот же доход, что у карты «Торговец»: выберите свой город, доход по всей его торговой сети", "1 Силикаты + 3 разных торговых ресурса", [specific("silicates", 1), category("trade", 3)]),
  ...
  // 🗣 Социальные
  B("upravlenie", "Управление", "social", "Всеобщая воинская повинность", 4, "5💰, без действия, без лимита цикла — +1 действие в этот ход (не более раза за ход)", "1 Силикаты + 1 Лес + 2 разных пищевых ресурса", [specific("silicates", 1), specific("wood", 1), category("food", 2)]),
