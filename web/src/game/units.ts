...
export const UNITS: UnitDef[] = [
  ...
  U("Авиация", "ranged", 5, "Авиация"), // было «САУ» (перешло Поддержке выше); технология перенесена с «Двигатель внутреннего сгорания» на одноимённую «Авиация» по прямому запросу
