...
export const RESOURCES: ResourceDef[] = [
  ...
  { id: "metalOre", label: "Металлические руды", category: "strategic", targetCount: 6, requiresWater: false, color: 0x5c6b73, symbol: "Fe" },
  { id: "silicates", label: "Силикаты", category: "strategic", targetCount: 3, requiresWater: false, color: 0xd4c5a0, symbol: "Si" },
  { id: "hydrocarbons", label: "Углеводороды", category: "strategic", targetCount: 6, requiresWater: false, color: 0x5a4632, symbol: "Уг" },
  ...
  { id: "rareEarth", label: "Редкоземельные материалы", category: "strategic", targetCount: 3, requiresWater: false, color: 0x9b59d0, symbol: "РЗ" },
